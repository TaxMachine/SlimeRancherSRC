...
// Type: MonomiPark.SlimeRancher.Persist.BindingsV03
...
namespace MonomiPark.SlimeRancher.Persist
{
  public class BindingsV03 : VersionedPersistedDataSet<BindingsV02>
  {
    ...
    public BindingsV03(BindingsV02 legacyData) => UpgradeFrom(legacyData);
    ...
    protected override void UpgradeFrom(BindingsV02 legacyData)
    {
      foreach (BindingsV02.Binding binding in legacyData.bindings)
        bindings.Add(new Binding(binding.action, binding.primKey, binding.primMouse, binding.secondary, 0, binding.gamepad));
    }
