...
// Type: MonomiPark.SlimeRancher.Persist.WorldV21
...
namespace MonomiPark.SlimeRancher.Persist
{
  public class WorldV21 : VersionedPersistedDataSet<WorldV20>
  {
    ...
    public override uint Version => 21;

    public WorldV21()
    {
    }

    public WorldV21(WorldV20 legacyData) => UpgradeFrom(legacyData);
    ...
    protected override void LoadData(BinaryReader reader)
    {
      ...
      placedGadgets = LoadDictionary(reader, r => r.ReadString(), r => PlacedGadgetV07.Load(r));
    ...
    {
      WorldV21 worldV21 = new WorldV21();
      worldV21.Load(reader.BaseStream);
      return worldV21;
    }
    ...
    public static void AssertAreEqual(WorldV21 expected, WorldV21 actual)
    {
      ...
      TestUtil.AssertAreEqual(expected.placedGadgets, actual.placedGadgets, (e, a) => PlacedGadgetV07.AssertAreEqual(e, a), "placedGadgets");
    ...
    public static void AssertAreEqual(WorldV20 expected, WorldV21 actual)
    {
      ...
      TestUtil.AssertAreEqual(expected.gordos, actual.gordos, (e, a) => GordoV01.AssertAreEqual(e, a), "gordos");
      TestUtil.AssertAreEqual(expected.resourceSpawnerWater, actual.resourceSpawnerWater, (e, a) => ResourceWaterV03.AssertAreEqual(e, a), "resourceSpawnerWater");
      TestUtil.AssertVersionedAreEqual(expected.placedGadgets, actual.placedGadgets, (e, a) => PlacedGadgetV07.AssertAreEqual(e, a), "placedGadgets");
      TestUtil.AssertAreEqual(expected.treasurePods, actual.treasurePods, (e, a) => TreasurePodV01.AssertAreEqual(e, a), "treasurePods");
      TestUtil.AssertAreEqual(expected.switches, actual.switches, (e, a) => { }, "switches");
      TestUtil.AssertAreEqual(expected.puzzleSlotsFilled, actual.puzzleSlotsFilled, (e, a) => { }, "puzzleSlotsFilled");
      TestUtil.AssertAreEqual(expected.occupiedPhaseSites, actual.occupiedPhaseSites, (e, a) => { }, "occupiedPhaseSites");
    ...
    protected override void UpgradeFrom(WorldV20 legacyData)
    {
      ...
      placedGadgets = legacyData.placedGadgets != null ? legacyData.placedGadgets.ToDictionary(kv => kv.Key, kv => new PlacedGadgetV07(kv.Value)) : null;
    }
  }
}
