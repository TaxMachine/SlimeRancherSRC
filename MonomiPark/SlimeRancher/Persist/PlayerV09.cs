...
// Type: MonomiPark.SlimeRancher.Persist.PlayerV09
...
namespace MonomiPark.SlimeRancher.Persist
{
  public class PlayerV09 : VersionedPersistedDataSet<PlayerV08>
  {
    ...
    public PlayerV09(PlayerV08 legacyData) => UpgradeFrom(legacyData);
    ...
    {
      PlayerV09 playerV09 = new PlayerV09();
      playerV09.Load(reader.BaseStream);
      return playerV09;
    }
