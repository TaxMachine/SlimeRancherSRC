...
// Type: MonomiPark.SlimeRancher.Persist.PlayerV14
...
namespace MonomiPark.SlimeRancher.Persist
{
  public class PlayerV14 : VersionedPersistedDataSet<PlayerV13>
  {
    ...
    public PlayerV14(PlayerV13 legacyData) => UpgradeFrom(legacyData);
    ...
    protected override void LoadData(BinaryReader reader)
    {
      ...
      decorizer = LoadPersistable<DecorizerV01>(reader);
    }
    ...
    protected override void WriteData(BinaryWriter writer)
    {
      ...
      WritePersistable(writer, decorizer);
    }

    public static PlayerV14 Load(BinaryReader reader)
    {
      PlayerV14 playerV14 = new PlayerV14();
      playerV14.Load(reader.BaseStream);
      return playerV14;
    }
