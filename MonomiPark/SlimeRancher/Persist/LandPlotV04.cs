...
// Type: MonomiPark.SlimeRancher.Persist.LandPlotV04
...
namespace MonomiPark.SlimeRancher.Persist
{
  public class LandPlotV04 : VersionedPersistedDataSet<LandPlotV03>
  {
    ...
    public void UpgradeFromLegacy(LandPlotV03 legacyData) => UpgradeFrom(legacyData);

    public static List<LandPlotV04> UpgradeList(List<LandPlotV03> legacyList)
    {
      List<LandPlotV04> landPlotV04List = new List<LandPlotV04>();
      foreach (LandPlotV03 legacy in legacyList)
      {
        LandPlotV04 landPlotV04 = new LandPlotV04();
        landPlotV04.UpgradeFrom(legacy);
        landPlotV04List.Add(landPlotV04);
      }
      return landPlotV04List;
    }
