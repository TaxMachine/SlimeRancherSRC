...
public class AvailBlueprintPopupUI : PopupUI<GadgetDefinition>, PopupDirector.Popup
{
  ...
  public void Update()
  {
    if (Time.time < (double) timeOfDeath)
      return;
    Destroyer.Destroy(gameObject, "AvailBlueprintPopupUI.Update");
  }
  ...
  {
    GameObject availBlueprintPopup = Instantiate(SRSingleton<SceneContext>.Instance.GadgetDirector.availBlueprintPopupPrefab);
    availBlueprintPopup.GetComponent<AvailBlueprintPopupUI>().Init(gadgetDefintion);
    return availBlueprintPopup;
  }
}
